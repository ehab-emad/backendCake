...
export const AppDataSource = new DataSource({
    ...
    entities: [
        ...
        path.resolve(__dirname, "src/infrastructure/database/models/Shape.model.ts"),
        path.resolve(__dirname, "src/infrastructure/database/models/ShapeImage.model.ts"),
        path.resolve(__dirname, "src/infrastructure/database/models/FlavorImage.model.ts"),
        path.resolve(__dirname, "src/infrastructure/database/models/MaskImage.model.ts"),
        path.resolve(__dirname, "src/infrastructure/database/models/Flavor.model.ts"),
        path.resolve(__dirname, "src/infrastructure/database/models/FlavorImage.model.ts"),
        path.resolve(__dirname, "src/infrastructure/database/models/Mask.model.ts"),
        path.resolve(__dirname, "src/infrastructure/database/models/MaskImage.model.ts"),
        path.resolve(__dirname, "src/infrastructure/database/models/FinalProduct.model.ts"),
